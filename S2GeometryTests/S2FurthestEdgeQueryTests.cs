...
namespace S2Geometry
{
    public class S2FurthestEdgeQueryTests
    {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_OptionsNotModified()
        {
            ...
            options.MinDistance = (S1ChordAngle.FromDegrees(1));
            options.MaxError = (S1ChordAngle.FromDegrees(0.001));
            var index = S2TextFormat.MakeIndexOrDie("0:1 | 0:2 | 0:3 # #");
            S2FurthestEdgeQuery query = new(index, options);
            S2FurthestEdgeQuery.PointTarget target = new(S2TextFormat.MakePointOrDie("0:4"));
            Assert.Equal(0, query.FindFurthestEdge(target).EdgeId());
            Assert2.Near(3.0, query.GetDistance(target).Degrees, S2Constants.DoubleError);
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_DistanceEqualToLimit()
        {
            ...
            var p0 = S2TextFormat.MakePointOrDie("23:12");
            S2Point p1 = S2TextFormat.MakePointOrDie("47:11");
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_TrueDistanceGreaterThanS1ChordAngleDistance()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_AntipodalPointInsideIndexedPolygon()
        {
            ...
            options.MinDistance = new(S1Angle.FromDegrees(178));
            S2FurthestEdgeQuery query = new(index, options);
            S2FurthestEdgeQuery.PointTarget target = new(-S2TextFormat.MakePointOrDie("2:12"));
            ...
            Assert.NotEqual(-1, results[0].EdgeId());
        }

        [Fact]
        public void Test_S2FurthestEdgeQuery_AntipodalPointOutsideIndexedPolygon()
        {
            ...
            S2FurthestEdgeQuery.Options options = new();
            options.IncludeInteriors = (true);
            options.MinDistance = new(S1Angle.FromDegrees(179));
            S2FurthestEdgeQuery query = new(index, options);
            S2FurthestEdgeQuery.PointTarget target = new(-S2TextFormat.MakePointOrDie("2:2"));
            var results = query.FindFurthestEdges(target);
            Assert.Empty(results);
        }

        [Fact]
        public void Test_S2FurthestEdgeQuery_TargetPolygonContainingIndexedPoints()
        {
            // Two points are contained within a polyline loop (no interior) and two
            // points are contained within a polygon.
            var index = S2TextFormat.MakeIndexOrDie("2:2 | 4:4 | 1:11 | 3:12 # #");
            S2FurthestEdgeQuery query = new(index);
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_AntipodalPolygonContainingIndexedPoints()
        {
            ...
            var antipodal_points = (
                from p in S2TextFormat.ParsePointsOrDie("2:2, 3:3, 1:11, 3:13")
                select -p).ToArray();
            MutableS2ShapeIndex index = new();
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_EmptyPolygonTarget()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_FullLaxPolygonTarget()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_FullS2PolygonTarget()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_CircleEdges()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_FractalEdges()
        {
        ...
        [Fact]
        public void Test_S2FurthestEdgeQuery_PointCloudEdges()
        {
        ...
        private static S1ChordAngle GetMaxDistanceToEdge(S2Point x, S2Point y0, S2Point y1)
        {
            ...
            S2EdgeDistances.UpdateMaxDistance(x, y0, y1, ref dist);
            return dist;
        }
                                 ...
                                 int num_queries)
        {
            ...
            List<S2Cap> index_caps = new List<S2Cap>();
            var indexes = new List<MutableS2ShapeIndex>();
            ...
            for (int i = 0; i < num_queries; ++i)
            {
                ...
                S2FurthestEdgeQuery query = new S2FurthestEdgeQuery(indexes[i_index]);

                // Exercise the opposite-hemisphere code 1/5 of the time.
                int antipodal = S2Testing.Random.OneIn(5) ? -1 : 1;
                S2Cap query_cap = new S2Cap(antipodal * index_cap.Center, query_radius);
                ...
                else if (target_type == 2)
                {
                    ...
                    S2Point a = S2Testing.SamplePoint(query_cap);
                    S2Cell cell = new S2Cell(new S2CellId(a).Parent(level));
                ...
                else
                {
                    ...
                    S2FurthestEdgeQuery.ShapeIndexTarget target = new S2FurthestEdgeQuery.ShapeIndexTarget(indexes[j_index]);
