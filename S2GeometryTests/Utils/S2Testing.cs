...
namespace S2Geometry
{
    ...
    public static class S2Testing
    {
        ...
        public static class Random
        {
            ...
            private static System.Random rnd = new System.Random(RandomSeed);
        ...
        public static S2Point RandomPoint() {
            ...
            return new S2Point(x, y, z).Normalized;
        }
        ...
        public static void GetRandomFrameAt(S2Point z, out S2Point x, out S2Point y) {
            x = z.CrossProd(RandomPoint()).Normalized;
            y = z.CrossProd(x).Normalized;
        }
        ...
        public static S2CellId GetRandomCellId() {
            return GetRandomCellId(Random.Uniform(S2Constants.kMaxCellLevel + 1));
        }
        ...
        public static void ConcentricLoopsPolygon(S2Point center, int num_loops, int num_vertices_per_loop, out S2Polygon polygon) {
            ...
            for (int li = 0; li < num_loops; ++li) {
                ...
                double radian_step = S2Constants.M_2_PI / num_vertices_per_loop;
                for (int vi = 0; vi < num_vertices_per_loop; ++vi) {
                    ...
                    vertices.Add(S2PointUtil.FromFrame(m, p.Normalized));
                }
        ...
        public static S2Point SamplePoint(S2Cap cap) {
            ...
            var m = S2PointUtil.GetFrame(cap.Center);
            ...
            double theta = S2Constants.M_2_PI * Random.RandDouble();
            ...
            return S2PointUtil.FromFrame(m, new S2Point(Math.Cos(theta) * r, Math.Sin(theta) * r, 1 - h))
                   .Normalized;
        }
        ...
        public static S2Point SamplePoint(S2LatLngRect rect) {
            ...
            double lng = rect.Lng.Lo + Random.RandDouble() * rect.Lng.Length;
        ...
        public static void CheckCovering(IS2Region region, S2CellUnion covering, bool check_tight, S2CellId id = null)
        {
            ...
            if (!region.MayIntersect(new S2Cell(id))) {
                ...
                if (check_tight) Assert.True(!covering.Intersects(id));
        ...
        public class Fractal
        {
            ...
            private void GetR2VerticesHelper(R2Point v0, R2Point v4, int level, List<R2Point> vertices) {
                ...
                var v2 = 0.5 * (v0 + v4) - offset_fraction_ * dir.Ortho;
