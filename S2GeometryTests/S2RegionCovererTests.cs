...
{
    public class S2RegionCovererTests
    {
...
#pragma warning restore CS0162 // Se detectó código inaccesible
        ...
        public void Test_IsCanonical_MaxCells()
        {
            ...
            Assert.True(IsCanonical(new[] { "1/1", "1/3" }, options));
            Assert.False(IsCanonical(new[] { "1/1", "1/3", "2/" }, options));
            Assert.True(IsCanonical(new[] { "1/123", "2/1", "3/0122" }, options));
        }
        ...
        public void Test_IsCanonical_Normalized()
        {
            ...
            Assert.True(IsCanonical(new[] { "0/22", "1/01", "1/02", "1/03", "1/10" }, options));
            Assert.False(IsCanonical(new[] { "0/22", "1/00", "1/01", "1/02", "1/03" }, options));

            options.MaxCells = (20);
            options.LevelMod = (2);
            Assert.True(IsCanonical(new[] {
                "1/1101", "1/1102", "1/1103", "1/1110",
                "1/1111", "1/1112", "1/1113", "1/1120",
                "1/1121", "1/1122", "1/1123", "1/1130",
                "1/1131", "1/1132", "1/1133", "1/1200"}, options));
            Assert.False(IsCanonical(new[] {
        ...
        public void Test_CanonicalizeCovering_WrongLevelMod()
        {
            ...
            TestCanonicalizeCovering(new[] { "0/0", "1/11", "2/222", "3/3333" },
                                     new[] { "0/0", "1/1", "2/2", "3/3333" }, options);
        }
        ...
        public void Test_CanonicalizeCovering_MaxCellsMergesSmallest()
        {
            ...
            TestCanonicalizeCovering(
                new[] { "0/", "1/0", "1/1", "2/01300", "2/0131313" },
                new[] { "0/", "1/", "2/013" }, options);
        }
