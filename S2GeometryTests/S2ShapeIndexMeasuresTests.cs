...
{
    [Fact]
    internal void Test_GetDimension_Empty() {
        Assert.Equal(-1, S2ShapeIndexMeasures.GetDimension(MakeIndexOrDie("# #")));
    }

    [Fact]
    internal void Test_GetDimension_Points() {
    ...
    [Fact]
    internal void Test_GetDimension_PointsAndLines() {
    ...
    [Fact]
    internal void Test_GetDimension_PointsLinesAndPolygons() {
