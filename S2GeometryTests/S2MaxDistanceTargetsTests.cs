...
namespace S2Geometry
{
    public class S2MaxDistanceTargetsTests
    {
        ...
        public void Test_CellTarget_GetCapBound()
        {
            for (int i = 0; i < 100; i++)
            {
                var cell = new S2Cell(S2Testing.GetRandomCellId());
                var target = new S2MaxDistanceCellTarget(cell);
        ...
        public void Test_IndexTarget_GetCapBound()
        {
            ...
            var polygon = new S2Polygon(new S2Cell(S2Testing.GetRandomCellId()));
            ...
            var target = new S2MaxDistanceShapeIndexTarget(index);
            var cap = target.GetCapBound();
        ...
        {
            var target = new S2MaxDistancePointTarget(MakePointOrDie("0:0"));
            S2MaxDistance dist0 = new S2MaxDistance(S1ChordAngle.FromDegrees(0));
            S2MaxDistance dist10 = new S2MaxDistance(S1ChordAngle.FromDegrees(10));

            // Update max distance target to point.
            S2Point p = MakePointOrDie("1:0");
            Assert.True(target.UpdateMinDistance(p, ref dist0));
            Assert2.Near(1.0, dist0.ToS1ChordAngle().Degrees, S2Constants.DoubleError);
            Assert.False(target.UpdateMinDistance(p, ref dist10));

            // Reset dist0 which was updated.
            dist0 = new S2MaxDistance(S1ChordAngle.FromDegrees(0));
            // Test for edges.
        ...
        public void Test_PointTarget_UpdateMaxDistanceToEdgeWhenEqual()
        {
            ...
            var target = new S2MaxDistancePointTarget(MakePointOrDie("1:0"));
        ...
        public void Test_EdgeTarget_UpdateMaxDistance()
        {
            ...
            var target = new S2MaxDistanceEdgeTarget(target_edge[0], target_edge[1]);
            S2MaxDistance dist0 = new S2MaxDistance(S1ChordAngle.FromDegrees(0));
            S2MaxDistance dist10 = new S2MaxDistance(S1ChordAngle.FromDegrees(10));
            ...
            Assert.True(target.UpdateMinDistance(p, ref dist0));
            Assert2.Near(3.0, dist0.ToS1ChordAngle().Degrees, S2Constants.DoubleError);
            Assert.False(target.UpdateMinDistance(p, ref dist10));
            ...
            Assert2.Near(4.0, dist0.ToS1ChordAngle().Degrees, S2Constants.DoubleError);
            Assert.False(target.UpdateMinDistance(p, ref dist10));
        ...
        {
            var target = new S2MaxDistanceEdgeTarget(MakePointOrDie("1:0"), MakePointOrDie("1:1"));
            var dist = S2MaxDistance.Infinity;
            var edge = ParsePointsOrDie("0:-1, 0:1");
            Assert.True(target.UpdateMinDistance(edge[0], edge[1], ref dist));
            Assert.False(target.UpdateMinDistance(edge[0], edge[1], ref dist));
        ...
        {
            var target = new S2MaxDistanceEdgeTarget(MakePointOrDie("0:89"),
                                 MakePointOrDie("0:91"));
            var dist = S2MaxDistance.Infinity;
        ...
        {
            var target = new S2MaxDistanceCellTarget(new S2Cell(new S2CellId(MakePointOrDie("0:1"))));
            var dist0 = new S2MaxDistance(S1ChordAngle.FromDegrees(0));
            var dist10 = new S2MaxDistance(S1ChordAngle.FromDegrees(10));
        ...
        public void Test_ShapeIndexTarget_UpdateMaxDistanceToEdgeWhenEqual()
        {
            ...
            var target = new S2MaxDistanceShapeIndexTarget(target_index);
            var dist = S2MaxDistance.Infinity;
            var edge = ParsePointsOrDie("0:-1, 0:1");
            Assert.True(target.UpdateMinDistance(edge[0], edge[1], ref dist));
            Assert.False(target.UpdateMinDistance(edge[0], edge[1], ref dist));
        ...
        {
            S2Point p = MakePointOrDie("0:0");
            var target = new S2MaxDistanceCellTarget(new S2Cell(p));
      ...
      "1:1 # 1:1, 2:2 # 0:0, 0:3, 3:0 | 6:6, 6:9, 9:6 | 0:0, 0:4, 4:0");
            ...
            var target = new S2MaxDistancePointTarget(-p);
      ...
      "1:1 # 1:1, 2:2 # 0:0, 0:3, 3:0 | 6:6, 6:9, 9:6 | 0:0, 0:4, 4:0");
            ...
            var target = new S2MaxDistanceEdgeTarget(-edge[0], -edge[1]);
            Assert.Equal((new int[] { 2 }), GetContainingShapes(target, index, 1));
            Assert.Equal((new int[] { 2, 4 }), GetContainingShapes(target, index, 5));
        }
        ...
        public void Test_CellTarget_VisitContainingShapes()
        {
            ...
            var target1 = new S2MaxDistanceCellTarget(new S2Cell(cellid1));
            ...
            var target2 = new S2MaxDistanceCellTarget(new S2Cell(cellid2));
        ...
        public void Test_ShapeIndexTarget_VisitContainingShapes()
        {
            ...
            // the index above.
            var target_index = new MutableS2ShapeIndex();

            var pts = Reflect(ParsePointsOrDie("1:1")).ToArray();
            target_index.Add(new S2PointVectorShape(pts));

            var line = new S2Polyline(Reflect(ParsePointsOrDie("4:5, 5:4")).ToArray());
            ...
            var loops = new List<List<S2Point>> { loop1, loop2 };
        ...
        public void Test_ShapeIndexTarget_VisitContainingShapesEmptyAndFull()
        {
            ...
            var point_target = new S2MaxDistanceShapeIndexTarget(point_index);
            ...
            var full_target = new S2MaxDistanceShapeIndexTarget(full_polygon_index);
            ...
            var empty_target = new S2MaxDistanceShapeIndexTarget(empty_polygon_index);
        ...
        {
            var negative_pts = new List<S2Point>();
        ...
        private int[] GetContainingShapes(S2MaxDistanceTargets target, S2ShapeIndex index, int max_shapes)
        {
