...
namespace S2Geometry
{
    public class EncodedS2CellIdVectorTests
    {
        ...
        public void Test_EncodedS2CellIdVector_MaximumShiftCell() {
            ...
            TestEncodedS2CellIdVector(new List<S2CellId> { S2TextFormat.MakeCellIdOrDie("0/00")}, 3);
        }
      ...
      { S2CellId.None, S2CellId.Sentinel, S2CellId.None}, 26);
        ...
        public void Test_EncodedS2CellIdVector_FourLevel10Children() {
            List<S2CellId> ids=new();
            var parent = S2TextFormat.MakeCellIdOrDie("3/012301230");
            for (S2CellId id = parent.ChildBegin();
        ...
        public void Test_EncodedS2CellIdVector_FractalS2ShapeIndexCells() {
            ...
            index.Add(new S2Loop.Shape(
                fractal.MakeLoop(S2PointUtil.GetFrame(center), S1Angle.FromDegrees(1))));
            List<S2CellId> ids=new();
    ...
    0x46caf54000000000
        ...
        public void Test_EncodedS2CellIdVector_LowerBoundLimits() {
            ...
            S2CellId first = S2CellId.Begin(S2Constants.kMaxCellLevel);
            S2CellId last = S2CellId.End(S2Constants.kMaxCellLevel).Prev;
            Encoder encoder=new();
            EncodedS2CellIdVector cell_ids = MakeEncodedS2CellIdVector(
                new List<S2CellId> { first, last}, encoder);
        ...
        private static void TestEncodedS2CellIdVector(List<UInt64> raw_expected, int expected_bytes)
        {
            ...
            {
                expected.Add(new S2CellId(raw_id));
            }
