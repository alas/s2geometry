...
namespace S2Geometry
{
    public class S2ShapeUtilBuildPolygonBoundariesTests
    {
        ...
        public void Test_BuildPolygonBoundaries_NoComponents()
        {
            ...
            S2ShapeUtil.S2ShapeX.BuildPolygonBoundaries(components, faces);
            Assert.Empty(faces);
        }
        ...
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 1:0, 0:1");  // Outer face
            TestLaxLoop a1 = new TestLaxLoop("0:0, 0:1, 1:0");
            var faces = new List<List<S2Shape>>();
        ...
        public void Test_BuildPolygonBoundaries_TwoLoopsSameComponent()
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 1:0, 0:1");  // Outer face
            TestLaxLoop a1 = new TestLaxLoop("0:0, 0:1, 1:0");
            TestLaxLoop a2 = new TestLaxLoop("1:0, 0:1, 1:1");
            var faces = new List<List<S2Shape>>();
        ...
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 3:0, 0:3");  // Outer face
            TestLaxLoop a1 = new TestLaxLoop("0:0, 0:3, 3:0");
            TestLaxLoop b0 = new TestLaxLoop("1:1, 2:0, 0:2");  // Outer face
            TestLaxLoop b1 = new TestLaxLoop("1:1, 0:2, 2:0");
            var faces = new List<List<S2Shape>>();
        ...
        public void Test_BuildPolygonBoundaries_TwoLoopsDifferentComponents()
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 1:0, 0:1");  // Outer face
            TestLaxLoop a1 = new TestLaxLoop("0:0, 0:1, 1:0");
            TestLaxLoop b0 = new TestLaxLoop("0:2, 1:2, 0:3");  // Outer face
            TestLaxLoop b1 = new TestLaxLoop("0:2, 0:3, 1:2");
            var faces = new List<List<S2Shape>>();
            var components = new List<List<S2Shape>> { new List<S2Shape> { a0, a1 }, new List<S2Shape> { b0, b1 } };
            S2ShapeUtil.S2ShapeX.BuildPolygonBoundaries(components, faces);
            Assert.Equal(3, faces.Count);
        ...
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 1:0, 0:0");
            var faces = new List<List<S2Shape>>();
        ...
        {
            TestLaxLoop a0 = new TestLaxLoop("0:0, 1:0, 0:0");
            TestLaxLoop b0 = new TestLaxLoop("2:0, 3:0, 2:0");
            var faces = new List<List<S2Shape>>();
        ...
        public void Test_BuildPolygonBoundaries_ComplexTest1()
        {
            ...
            TestLaxLoop a0 = new TestLaxLoop("0:0, 25:0, 50:0, 50:25, 50:50, 25:50, 0:50, 0:50");
            TestLaxLoop a1 = new TestLaxLoop("0:0, 0:25, 25:25, 25:0");
            TestLaxLoop a2 = new TestLaxLoop("0:25, 0:50, 25:50, 25:25");
            TestLaxLoop a3 = new TestLaxLoop("25:0, 25:25, 50:25, 50:0");
            TestLaxLoop a4 = new TestLaxLoop("25:25, 25:50, 50:50, 50:25");
            // Component "b" consists of a degenerate loop to the left of "a".
            TestLaxLoop b0 = new TestLaxLoop("0:-10, 10:-10");
            // Components "a1_a", "a1_b", and "a1_c" are located within "a1".
            TestLaxLoop a1_a0 = new TestLaxLoop("5:5, 20:5, 20:10, 5:10");
            TestLaxLoop a1_a1 = new TestLaxLoop("5:5, 5:10, 10:10, 10:5");
            TestLaxLoop a1_a2 = new TestLaxLoop("10:5, 10:10, 15:10, 15:5");
            TestLaxLoop a1_a3 = new TestLaxLoop("15:5, 15:10, 20:10, 20:5");
            TestLaxLoop a1_b0 = new TestLaxLoop("5:15, 20:15, 20:20, 5:20");
            TestLaxLoop a1_b1 = new TestLaxLoop("5:15, 5:20, 20:20, 20:15");
            TestLaxLoop a1_c0 = new TestLaxLoop("2:5, 2:10, 2:5");
            // Two components located inside "a1_a2" and "a1_a3".
            TestLaxLoop a1_a2_a0 = new TestLaxLoop("11:6, 14:6, 14:9, 11:9");
            TestLaxLoop a1_a2_a1 = new TestLaxLoop("11:6, 11:9, 14:9, 14:6");
            TestLaxLoop a1_a3_a0 = new TestLaxLoop("16:6, 19:9, 16:6");
            // Five component located inside "a3" and "a4".
            TestLaxLoop a3_a0 = new TestLaxLoop("30:5, 45:5, 45:20, 30:20");
            TestLaxLoop a3_a1 = new TestLaxLoop("30:5, 30:20, 45:20, 45:5");
            TestLaxLoop a4_a0 = new TestLaxLoop("30:30, 40:30, 30:30");
            TestLaxLoop a4_b0 = new TestLaxLoop("30:35, 40:35, 30:35");
            TestLaxLoop a4_c0 = new TestLaxLoop("30:40, 40:40, 30:40");
            TestLaxLoop a4_d0 = new TestLaxLoop("30:45, 40:45, 30:45");
            var components = new List<List<S2Shape>>
                {
        ...
        public class TestLaxLoop : S2LaxLoopShape
        {
            ...
            {
                var vertices = S2TextFormat.ParsePointsOrDie(vertex_str);
