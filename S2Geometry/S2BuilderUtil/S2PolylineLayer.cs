...
namespace S2Geometry.S2BuilderUtil
{
    ...
    public class S2PolylineLayer : S2Builder.Layer
    {
        public class Options
        {
            ...
            public Options()
            {
                EdgeType = S2Builder.EdgeType.DIRECTED; Validate = false;
            }
            ...
            public S2Builder.EdgeType EdgeType { get; set; }
        ...
        public override void Build(Graph g, out S2Error error)
        {
            ...
            if (g.NumEdges== 0)
            {
                polyline_.Init(Array.Empty<S2Point>());
                return;
            }
            ...
            {
                g.Vertex(g.GetEdge(edge_polyline[0]).Item1)
            };
            ...
            polyline_.Init(vertices.ToArray());
    ...
    public class IndexedS2PolylineLayer : S2Builder.Layer
    {
