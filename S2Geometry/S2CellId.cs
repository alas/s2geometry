...
public readonly record struct S2CellId(UInt64 Id) : IComparable<S2CellId>, IDecoder<S2CellId>
{
    ...
    public int Level()
    {
        // We can't just System.Diagnostics.Debug.Assert(IsValid) because we want Level to be
        ...
        System.Diagnostics.Debug.Assert(level >= 0 && level <= S2.kMaxCellLevel);
        return level;
    }
    ...
    public int ChildPosition(int level)
    {
        ...
        System.Diagnostics.Debug.Assert(level <= Level());
    ...
    {
        System.Diagnostics.Debug.Assert(IsValid());
        System.Diagnostics.Debug.Assert(other.IsValid());
    ...
    {
        System.Diagnostics.Debug.Assert(IsValid());
        System.Diagnostics.Debug.Assert(!IsFace());
    ...
    public int CommonAncestorLevel(S2CellId other)
    {
        ...
        System.Diagnostics.Debug.Assert(bits != 0);  // Because LowestOnBit is non-zero.
    ...
    {
        System.Diagnostics.Debug.Assert(nbr_level >= Level());
        int face = ToFaceIJOrientation(out int i, out int j, out _, false);
        ...
        System.Diagnostics.Debug.Assert(nbr_size <= size);
    ...
    public int ToFaceIJOrientation(out int pi, out int pj, out int orientation, bool setOrientation)
    {
        ...
        if (setOrientation)
        {
            ...
            // the kSwapMask bit.
            System.Diagnostics.Debug.Assert(0 == S2.kPosToOrientation[2]);
            System.Diagnostics.Debug.Assert(S2.kSwapMask == S2.kPosToOrientation[0]);
    ...
    private static S2CellId FromFaceIJWrap(int face, int i, int j)
    {
        ...
        System.Diagnostics.Debug.Assert(0 == kMaxSize % 2);
