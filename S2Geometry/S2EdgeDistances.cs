...
public static partial class S2
{
    ...
    {
        // See comments above.
        MyDebug.Assert(origin.IsUnitLength());
        MyDebug.Assert(dir.IsUnitLength());
        MyDebug.Assert(origin.DotProd(dir) <=
    ...
    {
        MyDebug.Assert(tolerance.Radians < S2.M_PI_2);
    ...
    {
        MyDebug.Assert(x.IsUnitLength() && a.IsUnitLength() && b.IsUnitLength());
        MyDebug.Assert(xa2 == (x - a).Norm2());
        MyDebug.Assert(xb2 == (x - b).Norm2());
