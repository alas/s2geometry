...
namespace S2Geometry
{
    ...
    public class S2CellIndex
    {
        ...
        public void Build()
        {
            ...
            deltas.Add(new DeltaBuild(S2CellId.Begin(S2Constants.kMaxCellLevel), S2CellId.None, -1));
            deltas.Add(new DeltaBuild(S2CellId.End(S2Constants.kMaxCellLevel), S2CellId.None, -1));
            deltas.Sort();
        ...
        public List<Int32> GetIntersectingLabels(S2CellUnion target)
        {
        ...
        public readonly struct CellNode
        {
            ...
            public static readonly CellNode Zero = new CellNode(S2CellId.None, kDoneContents, -1);
        ...
        public RangeNodeEnumerator GetRangeNodeEnumerator() => new RangeNodeEnumerator(range_nodes_, -1);

        public class RangeNodeEnumerator : IReversableEnumerator<RangeNode>, ICloneable
        {
            private readonly List<RangeNode> range_nodes_;
            ...
            public RangeNodeEnumerator(S2CellIndex index)
            {
                ...
                Position = -1;
                Assert.True(range_nodes_.Any()); // Call Build() first.
            }
            ...
            public object Clone() => new RangeNodeEnumerator(range_nodes_, Position);
        }
        ...
        public NonEmptyRangeEnumerator GetNERNEnum() => new NonEmptyRangeEnumerator(this);
        ...
        public readonly struct LabelledCell : IEquatable<LabelledCell>, IComparable<LabelledCell>
        {
            ...
            public static readonly LabelledCell Zero = new LabelledCell(S2CellId.None, -1);
