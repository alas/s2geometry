...
namespace S2Geometry
{
    ...
    public class S2PointIndex<Data> : IEnumerable<KeyData2<S2CellId, S2Point, Data>> where Data : IComparable<Data>
    {
        // Default constructor.
        public S2PointIndex() { }
        ...
        public void Add(S2Point point, Data data)
        {
            ...
            var tup = new KeyData2<S2CellId, S2Point, Data>(id, point, data);
            map_.AddSorted(tup);
        }
        ...
        public bool Remove(S2Point point, Data data)
        {
            ...
            var init = map_.GetLowerBound(new KeyData2<S2CellId, S2Point, Data>(id, point, data));
            for (var i = init; i < limit && map_[i].Item1 == id; i++)
            {
                var cur = (map_[i].Item2, map_[i].Item3);
        ...
        {
            return map_.GetLowerBound(new KeyData2<S2CellId, S2Point, Data>(target, default, default));
        }

        public KeyData2<S2CellId, S2Point, Data>? Get(int pos)
        {
            return map_.Count > pos ? map_[pos] : null;
        }

        public IEnumerator<KeyData2<S2CellId, S2Point, Data>> GetEnumerator()
        {
        ...
        // gtl.btree_multimap<S2CellId, PointData>; 
        private readonly List<KeyData2<S2CellId, S2Point, Data>> map_ = new List<KeyData2<S2CellId, S2Point, Data>>();
    }
}
