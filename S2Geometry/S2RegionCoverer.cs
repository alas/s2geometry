...
namespace S2Geometry
{
    ...
    public class S2RegionCoverer
    {
        ...
        { 
            ...
            Assert.True(options.MinLevel<= options.MaxLevel);
        }
        ...
        public bool IsCanonical(List<S2CellId> covering)
        {
            ...
            Assert.True(Options_.MinLevel<= Options_.MaxLevel);
        ...
        public void CanonicalizeCovering(List<S2CellId> covering)
        {
            ...
            // them with ancestors.
            if (Options_.MaxLevel< S2Constants.kMaxCellLevel || Options_.LevelMod> 1)
            {
            ...
            Assert.True(IsCanonical(covering));
        }
        ...
        public class Candidate
        {
            ...
            public int NumChildren { get; set; } // Number of children that intersect the region.
        ...
        private void AddCandidate(Candidate candidate, List<S2CellId> result)
        {
            ...
            Assert.True(candidate.NumChildren == 0);
        ...
        private List<S2CellId> GetCoveringInternal(IS2Region region)
        {
            ...
            Assert.True(IsCanonical(result));
            return result;
        }
        ...
        public class Options
        {
            ...
            public int MinLevel
            {
                ...
                set
                {
                    ...
                    _min_level = Math.Max(0, Math.Min(S2Constants.kMaxCellLevel, value));
                }
            }
            ...
            public int MaxLevel
            {
                ...
                set
                {
                    ...
                    Assert.True(value <= S2Constants.kMaxCellLevel);
                    // min_level() <= max_level() is checked by S2RegionCoverer.
                    max_level_ = Math.Max(0, Math.Min(S2Constants.kMaxCellLevel, value));
                }
            }
            private int max_level_ = S2Constants.kMaxCellLevel;
            ...
            //
            // DEFAULT: 1
            public int LevelMod { get => level_mod_;
                set
                {
                    Assert.True(value >= 1);
                    Assert.True(value <= 3);
...
#pragma warning restore IDE1006 // Estilos de nombres
        ...
        private readonly SortedSet<KeyData<int, Candidate>> pq_ = new SortedSet<KeyData<int, Candidate>>();
