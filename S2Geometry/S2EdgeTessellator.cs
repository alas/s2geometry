    ...
    public class S2EdgeTessellator
    {
        ...
        public void AppendProjected(S2Point a, S2Point b, List<R2Point> vertices)
        {
            ...
            else
            {
                ...
                Assert.True(vertices.Last() == pa); // Appended edges must form a chain
            }
        ...
        public void AppendUnprojected(R2Point a, R2Point b, List<S2Point> vertices)
        {
            ...
            else
            {
                ...
                Assert.True(S2PointUtil.ApproxEquals(vertices.Last(), pointA)); // Appended edges must form a chain
            }
        ...
        private S1ChordAngle EstimateMaxError(R2Point pa, S2Point a, R2Point pb, S2Point b)
        {
            ...
            S2Point mid1 = S2EdgeDistances.Interpolate(t1, a, b);
            S2Point mid2 = S2EdgeDistances.Interpolate(t2, a, b);
