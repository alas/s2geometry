...
using S2MinDistance = S2Geometry.S1ChordAngle;
...
using S2MinDistanceTarget = S2Geometry.S2DistanceTarget<S2Geometry.S1ChordAngle>;
...
namespace S2Geometry
{
    ...
    public class S2MinDistancePointTarget : S2MinDistanceTarget
    {
        ...
        {
            return S2EdgeDistances.UpdateMinDistance(point_, v0, v1, ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Cell cell, ref S2MinDistance min_dist)
        {
            return S2MinDistance.UpdateMin(cell.GetDistance(point_), ref min_dist);
        }
    ...
    public class S2MinDistanceEdgeTarget : S2MinDistanceTarget
    {
        ...
        public sealed override bool UpdateMinDistance(S2Point p, ref S2MinDistance min_dist)
        {
            return S2EdgeDistances.UpdateMinDistance(p, a_, b_, ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Point v0, S2Point v1, ref S2MinDistance min_dist)
        {
            return S2EdgeDistances.UpdateEdgePairMinDistance(a_, b_, v0, v1, ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Cell cell, ref S2MinDistance min_dist)
        {
            return S2MinDistance.UpdateMin(cell.GetDistance(a_, b_), ref min_dist);
        }
        public sealed override bool VisitContainingShapes(S2ShapeIndex index, ShapeVisitor visitor)
        {
            ...
            var target = new S2MinDistancePointTarget((a_ + b_).Normalized);
    ...
    public class S2MinDistanceCellTarget : S2MinDistanceTarget
    {
        ...
        public sealed override bool UpdateMinDistance(S2Point p, ref S2MinDistance min_dist)
        {
            return S2MinDistance.UpdateMin(cell_.GetDistance(p), ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Point v0, S2Point v1, ref S2MinDistance min_dist)
        {
            return S2MinDistance.UpdateMin(cell_.GetDistance(v0, v1), ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Cell cell, ref S2MinDistance min_dist)
        {
            return S2MinDistance.UpdateMin(cell_.GetDistance(cell), ref min_dist);
        }
        public sealed override bool VisitContainingShapes(S2ShapeIndex index, ShapeVisitor visitor)
        {
            ...
            var target = new S2MinDistancePointTarget(cell_.GetCenter());
            return target.VisitContainingShapes(index, visitor);
        }
    ...
    public class S2MinDistanceCellUnionTarget : S2MinDistanceTarget
    {
        ...
        public sealed override bool UpdateMinDistance(S2Point p, ref S1ChordAngle min_dist)
        {
            var target = new S2ClosestCellQuery.PointTarget(p);
            return UpdateMinDistance(target, ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Point v0, S2Point v1, ref S1ChordAngle min_dist)
        {
            var target = new S2ClosestCellQuery.EdgeTarget(v0, v1);
            return UpdateMinDistance(target, ref min_dist);
        }
        public sealed override bool UpdateMinDistance(S2Cell cell, ref S1ChordAngle min_dist)
        {
        ...
        private bool UpdateMinDistance(S2MinDistanceTarget target, ref S1ChordAngle min_dist)
        {
        ...
        private readonly S2CellIndex index_ = new S2CellIndex();
