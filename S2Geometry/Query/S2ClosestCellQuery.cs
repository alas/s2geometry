...
using Base = S2Geometry.S2ClosestCellQueryBase<S2Geometry.S1ChordAngle>;
using S2MinDistanceTarget = S2Geometry.S2DistanceTarget<S2Geometry.S1ChordAngle>; // S1ChordAngle = S2MinDistance, S2MinDistanceTarget = Target
