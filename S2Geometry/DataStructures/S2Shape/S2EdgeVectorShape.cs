...
namespace S2Geometry
{
    ...
    public class S2EdgeVectorShape : S2Shape
    {
        ...
        private readonly List<(S2Point, S2Point)> edges_ = new List<(S2Point, S2Point)>(); 
        ...
        public S2EdgeVectorShape(List<(S2Point, S2Point)> edges)
        {
            edges_ = edges;
        }
        ...
        // S2Shape interface:
        public sealed override int NumEdges => edges_.Count;
        public sealed override Edge GetEdge(int e)
        {
            return new Edge(edges_[e].Item1, edges_[e].Item2);
        }
        ...
        public sealed override int NumChains() { return edges_.Count; }
