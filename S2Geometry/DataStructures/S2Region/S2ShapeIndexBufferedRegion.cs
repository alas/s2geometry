...
namespace S2Geometry
{
    ...
    public sealed class S2ShapeIndexBufferedRegion : S2Region<S2ShapeIndexBufferedRegion>, IEquatable<S2ShapeIndexBufferedRegion>
    {
        ...
        {
            return new S2ShapeIndexBufferedRegion(Index(), Radius);
        }
        ...
        public override void GetCellUnionBound(List<S2CellId> cellids)
        {
            ...
            int max_level = S2Metrics.kMinWidth.GetLevelForMinValue(radians) - 1;
            if (max_level < 0)
            {
        ...
        public override bool Contains(S2Cell cell)
        {
            ...
            var target = new S2ClosestEdgeQuery.PointTarget(cell.GetCenter());
        ...
        public override bool Equals(S2ShapeIndexBufferedRegion other)
        {
