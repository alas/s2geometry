...
namespace S2Geometry
{
    ...
    /// </summary>
    public readonly struct S1Angle : IEquatable<S1Angle>, IComparable<S1Angle>
    {
        #region Fields, Constants

        public readonly double Radians;
        
        public static readonly S1Angle Infinity = new S1Angle(double.PositiveInfinity);
        public static readonly S1Angle Zero = new S1Angle(0);
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        public S1Angle(S2Point x, S2Point y) => Radians = x.Angle(y);
        ...
        /// </summary>
        public S1Angle(S2LatLng x, S2LatLng y) => Radians = x.GetDistance(y).Radians;
        ...
        public static S1Angle FromRadians(double radians) => new S1Angle(radians);

        public static S1Angle FromDegrees(double degrees) => new S1Angle(degrees * S2Constants.M_PI_180);
        ...
        public double Degrees => Radians * S2Constants.M_180_PI;
        ...
        public long E5 => (long)Math.Round(Degrees * 1e5);
        public long E6 => (long)Math.Round(Degrees * 1e6);
        public long E7 => (long)Math.Round(Degrees * 1e7);
        ...
        {
            var rads = Math.IEEERemainder(Radians, S2Constants.M_2_PI);
        ...
        public bool Equals(S1Angle other) => Radians == other.Radians;

        public override bool Equals(object obj) => obj is S1Angle angle && Equals(angle);

        public override int GetHashCode() => Radians.GetHashCode();

        public static bool operator ==(S1Angle left, S1Angle right) => Equals(left, right);
        ...
        public int CompareTo(S1Angle other) => Radians < other.Radians ? -1 : Radians > other.Radians ? 1 : 0;
        ...
        public static S1Angle operator -(S1Angle a) => new S1Angle(-a.Radians);
        ...
        /// </summary>
        public override string ToString() => $"{Degrees}d"; 
